...
module RbConfig
  ...
  CONFIG["configure_args"] = " '--host=arm-linux-androideabi' '--target=arm-linux-androideabi' '--prefix=/opt/android-ndk/platforms/android-9/arch-arm/usr' '--prefix=/system' '--disable-rpath' '--with-ncurses-include=/media/data/documents/programs/dsploit/dSploit/jni/ncurses/include' '--with-libyaml-include=/media/data/documents/programs/dsploit/dSploit/jni/libyaml/include' '--with-iconv-include=/media/data/documents/programs/dsploit/dSploit/jni/libiconv/include' '--with-openssl-include=/media/data/documents/programs/dsploit/dSploit/jni/openssl/include' '--with-readline-include=/media/data/documents/programs/dsploit/dSploit/jni/libreadline' 'host_alias=arm-linux-androideabi' 'target_alias=arm-linux-androideabi' 'CC=/opt/android-ndk/toolchains/arm-linux-androideabi-4.8/prebuilt/linux-x86_64/bin/arm-linux-androideabi-gcc' 'CFLAGS= --sysroot=/opt/android-ndk/platforms/android-9/arch-arm' 'LDFLAGS=--sysroot=/opt/android-ndk/platforms/android-9/arch-arm -L/media/data/documents/programs/dsploit/dSploit/obj/local/armeabi/' 'CPPFLAGS= --sysroot=/opt/android-ndk/platforms/android-9/arch-arm' 'CXX=/opt/android-ndk/toolchains/arm-linux-androideabi-4.8/prebuilt/linux-x86_64/bin/arm-linux-androideabi-g++' 'CXXFLAGS= --sysroot=/opt/android-ndk/platforms/android-9/arch-arm' 'CPP=/opt/android-ndk/toolchains/arm-linux-androideabi-4.8/prebuilt/linux-x86_64/bin/arm-linux-androideabi-cpp'"
  ...
  CONFIG["LDFLAGS"] = "-L. --sysroot=/opt/android-ndk/platforms/android-9/arch-arm -L/media/data/documents/programs/dsploit/dSploit/obj/local/armeabi/ -rdynamic -Wl,-export-dynamic"
